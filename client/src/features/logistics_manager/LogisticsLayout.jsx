      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        <header className="shrink-0 h-14 flex items-center justify-between px-6 gap-4
          ...
          <div className="hidden md:flex items-center gap-2 flex-1 max-w-xs mx-6
                          ...
                          focus-within:border-green-500/40 transition-colors duration-200">
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-1.5 w-44 bg-[#111] border border-white/[0.08] rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] z-50 overflow-hidden">
                  <div className="p-1">
                    <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs text-white/60 hover:text-white hover:bg-white/[0.05] transition-all">
                    ...
                    <button className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs text-red-400/80 hover:text-red-300 hover:bg-red-500/[0.07] transition-all">
