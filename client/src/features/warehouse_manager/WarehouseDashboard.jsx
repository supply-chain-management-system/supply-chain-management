    ...
    <div className="bg-[#f8fafc] min-h-screen p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex gap-3">
            <button
              onClick={exportCSV}
              className="bg-white border border-slate-200 px-4 py-2 rounded-md text-sm font-semibold text-slate-600 hover:bg-slate-50 transition-all"
            >
              Export CSV
            </button>
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          ...
          <div className="bg-white w-[350px] rounded-xl p-6 shadow-xl">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 border border-slate-300 py-2 rounded-md"
              >
                Cancel
              </button>
