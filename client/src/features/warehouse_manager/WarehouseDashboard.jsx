          ...
          <div className="bg-white w-full max-w-md rounded-xl p-6 shadow-xl border border-slate-200">
            ...
            <div className="flex gap-3 mt-8">
              <button
                ...
                className="flex-1 border border-slate-300 py-2.5 rounded-lg font-medium text-slate-600 hover:bg-slate-50"
              >
                Ignore
              </button>
              ...
              <button
                ...
                className={`flex-1 py-2.5 rounded-lg font-bold text-white shadow-md ${
                  !selectedReceiverId
