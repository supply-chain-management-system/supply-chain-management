...
const ProfilePage = () => {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      setErrorMsg("Could not retrieve profile information. Please try reload.");
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4 text-cyan-400">
        <Loader2 size={36} className="animate-spin" />
        <span className="text-sm font-black uppercase tracking-widest">Accessing Secure Profile...</span>
      </div>
    );
  }
    ...
    <div className="space-y-10 animate-in fade-in duration-500 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-4xl font-black text-white tracking-tighter uppercase">
          Manager <span className="text-cyan-400">Profile</span>
        </h1>
        <p className="text-xs text-gray-500 font-bold uppercase tracking-widest">
          Personal identification & administrative boundaries
        </p>
      </div>
        ...
        <div className="md:col-span-1 space-y-6">
          <GlassCard className="p-6 flex flex-col items-center text-center">
            ...
            <div className="relative group mb-6">
              <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-cyan-400 via-cyan-500 to-blue-600 p-[3px] shadow-[0_0_30px_rgba(6,182,212,0.25)] transition-transform duration-500 group-hover:scale-105">
                <div className="w-full h-full rounded-[21px] bg-[#101925] flex items-center justify-center text-white font-black text-3xl">
          ...
          <form onSubmit={handleSave}>
            <GlassCard className="p-8 space-y-6">
              <h3 className="font-black text-white flex items-center gap-2 mb-2 text-xs uppercase tracking-widest border-b border-white/5 pb-4">
                <User size={14} className="text-cyan-400" /> Professional Details
              </h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-11 pl-11 pr-4 rounded-xl bg-white/[0.02] border border-white/[0.08] focus:border-cyan-500 focus:outline-none text-xs font-semibold text-white transition-colors"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Boston Headquarters"
                      className="w-full h-11 pl-11 pr-4 rounded-xl bg-white/[0.02] border border-white/[0.08] focus:border-cyan-500 focus:outline-none text-xs font-semibold text-white transition-colors"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-xl bg-white/[0.02] border border-white/[0.08] focus:border-cyan-500 focus:outline-none text-xs font-semibold text-white transition-colors resize-none"
                />
              </div>

              {/* Business Manager Role-specific settings */}
              <div className="space-y-6 pt-4 border-t border-white/5">
                <h3 className="font-black text-cyan-400 flex items-center gap-2 text-xs uppercase tracking-widest">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <DollarSign size={14} className="absolute left-4 top-3.5 text-cyan-400" />
                      <input
                        type="text"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <TrendingUp size={14} className="absolute left-4 top-3.5 text-cyan-400" />
                      <input
                        type="text"
                        name="focus_area"
              ...
              <div className="pt-4 flex justify-end">
                <button
                  type="submit"
                  disabled={saving}
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:shadow-[0_0_25px_rgba(6,182,212,0.4)] disabled:opacity-50 disabled:scale-100 active:scale-95 duration-200"
                >
                  {saving ? (
                    <>
