        ...
        <div className={`w-80 flex flex-shrink-0 flex-col border-r transition-all duration-300 ${tBorder} ${theme.sidebar}`}>
          ...
          <div className={`p-4 border-b flex items-center justify-between ${tBorder}`}>
            ...
            <div className="relative">
              ...
              {showStatusDropdown && (
                <div className={`absolute right-0 mt-1 w-28 rounded-xl p-1 z-20 shadow-2xl ${isLight ? "bg-white border border-slate-200" : "bg-slate-900 border border-white/10"
                  }`}>
          ...
          <div className={`p-4 border-b flex flex-col gap-3 ${tBorder}`}>
            ...
            <div className={`flex p-1 rounded-xl border ${tCardBg} w-full`}>
              <button
                ...
                className={`flex-1 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all text-center ${activeTab === "groups"
              ...
              <button
                ...
                className={`flex-1 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all text-center ${activeTab === "dms"
                    ? isLight ? "bg-slate-950 text-white shadow-sm" : "bg-white/10 text-white shadow-sm"
                    : `${tTextMuted} hover:${tTextTitle}`
                  }`}
              >
                  ...
                  {filteredRooms.map((room) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-bold transition-all text-left border border-transparent ${isActive
                            ? theme.activeItem
                            : `text-slate-400 hover:${tTextTitle} ${tHoverBg}`
                          }`}
                      >
                        <div className="relative flex-shrink-0">
                          <div className={`w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-black ${isActive ? (isLight ? "bg-slate-800 text-white" : "bg-white/10 text-white") : tCardBg
                            } ${isActive ? "" : tTextTitle}`}>
            ...
            <>
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <div className="relative flex-shrink-0">
                    ...
                    {(() => {
                      ...
                      const dotColor = isOnline ? "bg-emerald-500" : "bg-rose-500";
                      return (
                        <div className={`absolute -bottom-0.5 -left-0.5 w-2.5 h-2.5 rounded-full border-2 ${isLight ? "border-white" : "border-slate-900"
                          } ${dotColor}`} />
                      );
                    })()}
                  </div>
                  <div className="flex flex-col min-w-0">
                    ...
                    {(() => {
                      ...
                      const isOnline = status.label === "Joined" || status.label === "Online";
                      return (
                        <span className={`text-[9px] font-black uppercase tracking-wider mt-1 ${isOnline ? "text-emerald-500" : "text-rose-500"
                          }`}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`p-1.5 rounded-lg transition-all relative ${showNotifDropdown
                            ...
                            notifications.map((notif) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`w-full text-left p-2.5 rounded-xl transition-all flex flex-col gap-1 border border-transparent ${!notif.is_read
                                ...
                                >
                                  ...
                                  {isPending ? (
                                    ...
                                    notif.status && notif.status !== "pending" && (
                                      <span className={`text-[9px] font-bold mt-1 uppercase tracking-wider ${notif.status === "accepted" ? "text-emerald-400" : "text-rose-400"
                                        }`}>
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-lg transition-all ${showRoomInfo
                        ? isLight ? "bg-slate-200 text-slate-900" : "bg-white/10 text-white"
                        : `${tTextMuted} hover:${tTextTitle} ${tHoverBg}`
                      }`}
                    title="Room Info"
                  ...
                  <div className={`flex items-center gap-1 p-1 rounded-xl border ${tCardBg}`}>
                    {Object.keys(THEMES).map((tId) => (
                      <button
                        ...
                        className={`px-2 py-0.5 rounded-lg text-[8px] font-bold uppercase tracking-wider transition-all ${activeTheme === tId
                            ? isLight ? "bg-slate-950 text-white shadow-sm" : "bg-white/10 text-white shadow-sm"
                            : `${tTextMuted} hover:${tTextTitle}`
                          }`}
                      >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-end gap-2 max-w-[75%] relative">
                            ...
                            {["👍", "❤️", "🔥", "👏", "⚠️"].map((emoji) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-5.5 h-5.5 flex items-center justify-center rounded-lg text-xs hover:scale-125 transition-transform ${hasReacted
                        ...
                        {/* Bubble */}
                        <div className={`px-4 py-2.5 rounded-2xl text-xs font-semibold leading-relaxed break-words border ${isMe
                          ...
                          {Object.entries(msg.reactions).map(([emoji, usersList]) => {
                            ...
                            return (
                              <button
                                key={emoji}
                                onClick={() => handleToggleReaction(msg.id, emoji)}
                                className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[9px] font-bold border transition-all ${hasReacted
              ...
              <div className={`p-4 border-t transition-all duration-300 ${isLight ? "bg-slate-50" : "bg-black/30"} ${tBorder}`}>
                ...
                <form onSubmit={editingMessageId ? handleSaveEdit : handleSendMessage} className="flex gap-3 max-w-4xl mx-auto w-full">
                  <div className={`flex-1 flex items-center gap-2 px-4 py-1.5 rounded-2xl border transition-all ${tCardBg} focus-within:ring-2 ${isLight ? "focus-within:ring-slate-900/10 focus-within:border-slate-500" : "focus-within:ring-white/10 focus-within:border-white/20"
                    }`}>
                    <input
                      type="text"
                      value={newMessage}
                      ...
                      <div className="max-h-40 overflow-y-auto space-y-1.5 pr-1 custom-scrollbar">
                        {getGroupMembers().map((member) => (
                          ...
                          >
                            ...
                            <span className={`text-[8px] font-black uppercase px-1.5 py-0.5 rounded-md ${member.id === activeRoom.created_by
              ...
              <div className={`pt-2 border-t ${tBorder}`}>
                <label className={`flex items-center gap-2.5 cursor-pointer text-[10px] font-bold transition-all select-none ${tTextMuted} hover:${tTextTitle}`}>
                  <input
                    ...
                    className={`rounded text-violet-500 focus:ring-0 focus:ring-offset-0 ${isLight ? "bg-white border-slate-300 text-slate-900" : "bg-slate-900 border-white/10 text-violet-500"
                      }`}
                  />
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          <input
                            ...
                            className={`rounded focus:ring-0 focus:ring-offset-0 ${isLight ? "bg-white border-slate-300 text-slate-900" : "bg-slate-950 border-white/10"
                              }`}
                          />
                        ...
                        <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-md ${isLight ? "bg-slate-200 text-slate-700" : "bg-white/5 text-gray-400"
                          }`}>
                          {user.role?.replace("_", " ")}
                        </span>
                      </label>
