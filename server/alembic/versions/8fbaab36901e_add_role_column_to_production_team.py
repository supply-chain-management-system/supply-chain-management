"""add role column to production_team

Revision ID: 8fbaab36901e
Revises: df9c5e2796a5
Create Date: 2026-05-03 23:57:52.172849
...
revision: str = '8fbaab36901e'
down_revision: Union[str, Sequence[str], None] = 'df9c5e2796a5'
...
def upgrade() -> None:
    ...
    op.add_column('production_team', sa.Column('role', sa.Enum('Worker', 'Operator', 'Supervisor', name='worker_role'), nullable=True))
    op.alter_column('workers', 'role',
               existing_type=postgresql.ENUM('Worker', 'Operator', 'Supervisor', name='worker_role'),
               nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column('workers', 'role',
               existing_type=postgresql.ENUM('Worker', 'Operator', 'Supervisor', name='worker_role'),
               nullable=False)
    op.drop_column('production_team', 'role')
