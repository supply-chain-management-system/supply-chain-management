...
Revision ID: 761a9435d4ab
Revises: 1b5a03ee9a45
Create Date: 2026-05-15 05:43:28.681138
...
revision: str = '761a9435d4ab'
down_revision: Union[str, Sequence[str], None] = '1b5a03ee9a45'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('business_id', sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('team_managers_pkey')),
    sa.UniqueConstraint('email', name=op.f('team_managers_email_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
